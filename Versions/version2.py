...
w=Label(text="...",font=("roboto",18,"bold"),bg="yellow")
w.place(x=125,y=430)
h=Label(text="...",font=("roboto",18,"bold"),bg="yellow")
h.place(x=270,y=430)
d=Label(text="...",font=("roboto",18,"bold"),bg="yellow")
d.place(x=430,y=430)
p=Label(text="...",font=("roboto",18,"bold"),bg="yellow")
p.place(x=670,y=430)
